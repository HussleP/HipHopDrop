...
const styles = StyleSheet.create({
  ...
  primaryBtnText: { color: '#000', fontSize: 16, fontWeight: '500' },
  stepTitle: {
    color: colors.textPrimary,
    fontSize: 26,
    fontWeight: '700',
  ...
  pillActive: { backgroundColor: colors.accentTeal, borderColor: colors.accentTeal },
  pillText: { color: colors.textMuted, fontSize: 14, fontWeight: '500' },
