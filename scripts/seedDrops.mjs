...
// firebase is ESM — use dynamic import
...
// Top-level await requires Node 18+ or --experimental-vm-modules
// Run with: node --input-type=module scripts/seedDrops.js
// OR just: node scripts/seedDrops.js  (Node 18+ supports top-level await in .mjs)
